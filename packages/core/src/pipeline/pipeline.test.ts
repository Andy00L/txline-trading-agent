...
const oddsEvent = (
  ...
  envelope: {
    ...
    payload: {
      ...
      period: 'full-game',
      lines: [
        { outcome: 'home', label: 'home', decimalOddsMilli: oddsMilli(homeMilli), impliedPct: null },
        { outcome: 'draw', label: 'draw', decimalOddsMilli: oddsMilli(drawMilli), impliedPct: null },
        { outcome: 'away', label: 'away', decimalOddsMilli: oddsMilli(awayMilli), impliedPct: null },
      ],
    },
  },
});
